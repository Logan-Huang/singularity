...
#[repr(u32)]
pub enum EdgeColor {
    Black = ffi::msdfgen_EdgeColor_BLACK as u32,
    Blue = ffi::msdfgen_EdgeColor_BLUE as u32,
    Cyan = ffi::msdfgen_EdgeColor_CYAN as u32,
    Green = ffi::msdfgen_EdgeColor_GREEN as u32,
    Magenta = ffi::msdfgen_EdgeColor_MAGENTA as u32,
    Red = ffi::msdfgen_EdgeColor_RED as u32,
    White = ffi::msdfgen_EdgeColor_WHITE as u32,
    Yellow = ffi::msdfgen_EdgeColor_YELLOW as u32,
}
