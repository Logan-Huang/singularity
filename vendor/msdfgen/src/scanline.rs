...
#[repr(u32)]
pub enum FillRule {
    Negative = ffi::msdfgen_FillRule_FILL_NEGATIVE as u32,
    NonZero = ffi::msdfgen_FillRule_FILL_NONZERO as u32,
    Odd = ffi::msdfgen_FillRule_FILL_ODD as u32,
    Positive = ffi::msdfgen_FillRule_FILL_POSITIVE as u32,
}
...
impl FillRule {
    // PATCHED (was -> u32): the ffi alias is i32 on MSVC targets, u32 elsewhere
    pub(crate) fn into_raw(self) -> ffi::msdfgen_FillRule {
        self as _
    }
